...
class Sunset_Profile_Widget extends WP_Widget{
	...
	public function form( $instance ){
		echo '<p><strong>No options for this Widget!</strong><br>You can control the fields of this Widget from <a href="./admin.php?page=alecadd_sunset">This Page</a></p>';
	}

	// front-end dispaly of widget
		...
		<div class="text-center">
			...
			<div class="icons-wrapper">
				...
				<?php if( !empty ($gplus_icon)) : ?>
					<a href="https://plus.google.com/u/0/+<?php echo $gplus_icon ?>" target="_blank">
