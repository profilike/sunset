...
function  sunset_load_admin_scripts( $hook ){
	...
	if ( 'sunset_page_alecadd_sunset_css' == $hook ){
...
function sunset_load_scripts(){
	...
	wp_enqueue_style( 'sunset', get_template_directory_uri() . '/css/sunset.css', array(),'1.1.0', 'all' );
	wp_enqueue_style('raleway', 'https://fonts.googleapis.com/css?family=Raleway:200,300,400,500');
	wp_enqueue_style('fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');

	
	
	wp_deregister_script( 'jquery' );
	wp_register_script( 'jquery',  get_template_directory_uri() . '/js/jquery-1.11.2.min.js', false, '1.11.3', true );
